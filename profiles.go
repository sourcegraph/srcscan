...
var AllProfiles = []Profile{
        ...
        Profile{
                Name: "Clojure package",
                Dir: FileInDir{"project.clj"},
                // File: FileHasSuffix{".clj"}, // probably don't need this
                Unit: func(abspath, relpath string, config Config, info os.FileInfo) Unit {
                        fmt.Println("##### found source unit (in srcscan/profiles.go)")
                        return &ClojurePackage{relpath}
                },
        },
        Profile{
